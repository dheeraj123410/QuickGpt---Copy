  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex items-center justify-center w-full mt-10 py-2 text-white bg-gradient-to-r from-[#A456F7] to-[#3D81F6] rounded-md text-sm cursor-pointer hover:opacity-90 transition"
      >
